  ...
  return (
    <animated.div style={fadeIn}>
      <Box p={3} style={{ paddingTop: '80px' }}>
        ...
        <Box mt={3} mb={3}>
          <Typography variant="h5" gutterBottom align="center" style={{ color: '#FFFFFF' }}>
            KEY STACK PROFICIENCIES
          </Typography>
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
        ...
        <Box mt={3} mb={3}>
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  Trainwithamandajane -{' '}
                  <a href="https://trainwithamandajane.com/" target="_blank" rel="noopener noreferrer">
                    App
                  </a>
                </Typography>
                <Typography variant="body1">
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  Cohorty -{' '}
                  <a href="https://github.com/Barefootjiggy/cohorty-frontend/tree/dev" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </a>{' '}
                  |{' '}
                  <a href="https://cohorty-frontend.vercel.app/" target="_blank" rel="noopener noreferrer">
                    App
                  </a>
                </Typography>
                <Typography variant="body1">
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  Dutch -{' '}
                  <a href="https://github.com/Barefootjiggy/Dutch-Frontend" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </a>{' '}
                  |{' '}
                  <a href="https://frontend-dutch-by-wahgee.vercel.app/" target="_blank" rel="noopener noreferrer">
                    App
                  </a>
                </Typography>
                <Typography variant="body1">
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  WOD4U -{' '}
                  <a href="https://github.com/Barefootjiggy/Connect-4" target="_blank" rel="noopener noreferrer">
                    GitHub
                  </a>{' '}
                  |{' '}
                  <a href="https://wod4u.netlify.app/" target="_blank" rel="noopener noreferrer">
                    App
                  </a>
                </Typography>
                <Typography variant="body1">
            ...
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  ...
                  |{' '}
                  <a href="https://connect-4-hazel.vercel.app/" target="_blank" rel="noopener noreferrer">
                    App
                  </a>
                </Typography>
                <Typography variant="body1">
        ...
        <Box mt={3} mb={3}>
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  VNS Health, Authorization Coordinator
                </Typography>
                <Typography variant="body1">
        ...
        <Box mt={3} mb={3}>
          ...
          <Box mb={3}>
            <Paper elevation={3}>
              <Box p={3}>
                <Typography variant="h6" style={{ color: '#ab598b' }}>
                  Western New England, B.S.B.A - Management and Leadership
                </Typography>
                <Typography variant="body1">
